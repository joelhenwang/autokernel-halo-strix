...
- 5/7 ops are Phase-B-fixed (autograd-safe).
- 2/7 ops cause graph breaks (T-3.2 targets).
- 0/7 ops have `register_autocast` rules registered.
...
|---|---:|---:|---:|---:|---:|---|
| `autokernel::silu_gate_mul` | True | False | True | True | False | --ak-swiglu-fwd,--ak-swiglu-bwd |
| `autokernel::rmsnorm` | True | False | True | True | False | --ak-rmsnorm |
| `autokernel::fused_res_rmsnorm` | True | False | True | True | False | --ak-res-rmsnorm |
| `autokernel::rotary_emb_fp32` | True | False | True | True | False | --ak-rope |
