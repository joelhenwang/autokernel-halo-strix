...
Total: ~1.5-3 GB — fits trivially in your 108 GB unified memory

Arithmetic intensity consideration: The 8060S has no MFMA/matrix cores, so all matmuls go through VALU (vector ALU). That hurts. But 20 CUs × wave32 still gives you meaningful throughput for a 124M model. 10K tok/s suggests you might have bottlenecks in:
...
# With 108GB unified memory and a 124M model, you can go BIG
