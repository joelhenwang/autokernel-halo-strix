"""
Fused cross-entropy kernel (v4: online softmax, HIP/gfx1151).

This is the implementation module. Public API is re-exported via the
root-level ``kernel.py`` facade (required by bench.py contract).
