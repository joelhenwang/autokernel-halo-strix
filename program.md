...
The full optimization playbook (6 tiers, kernel-specific tricks, anti-patterns) is at:
`knowledge/kernels/hip_optimization_playbook.md`. Reference it when experimenting on a kernel.
